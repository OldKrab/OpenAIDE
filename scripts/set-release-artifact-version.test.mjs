...
test("stamps the exact release version into every packaged artifact manifest", () => {
  ...
  assert.equal(packageJson(repoRoot, "apps/desktop-validation/package.json").version, "0.0.1-alpha.9");
  assert.equal(
    packageJson(repoRoot, "apps/desktop-validation/src-tauri/tauri.conf.json").version,
    "0.0.1-alpha.9",
  );
  ...
  assert.match(
    readFileSync(path.join(repoRoot, "apps/desktop-validation/src-tauri/Cargo.lock"), "utf8"),
    /name = "openaide-desktop-validation"\nversion = "0\.0\.1-alpha\.9"/,
  );
});
...
function fixtureRepo(lineEnding = "\n") {
  ...
  writeFixture(repoRoot, "apps/desktop-validation/package.json", {
    name: "desktop",
    private: true,
    version: "0.0.0",
  });
  writeFixture(repoRoot, "apps/desktop-validation/src-tauri/tauri.conf.json", {
  ...
  writeFixture(
    repoRoot,
    "apps/desktop-validation/src-tauri/Cargo.toml",
    ["[package]", 'name = "openaide-desktop-validation"', 'version = "0.0.0"', ""].join(lineEnding),
  );
  writeFixture(
    repoRoot,
    "Cargo.lock",
  ...
  writeFixture(
    repoRoot,
    "apps/desktop-validation/src-tauri/Cargo.lock",
    [
      "# This file is automatically @generated by Cargo.",
      "version = 4",
      "",
