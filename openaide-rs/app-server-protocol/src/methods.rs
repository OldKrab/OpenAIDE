...
protocol_method!(
    AgentCancelAuthenticate,
    AGENT_CANCEL_AUTHENTICATE,
    AgentCancelAuthenticateParams,
    AgentCancelAuthenticateResult
);
protocol_method!(
    AgentLogout,
    AGENT_LOGOUT,
...
protocol_method!(ProjectAdd, PROJECT_ADD, ProjectAddParams, ProjectAddResult);
protocol_method!(
    ProjectRename,
    PROJECT_RENAME,
    ProjectRenameParams,
