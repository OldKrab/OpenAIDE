use crate::methods::{
    ...
    PENDING_REQUEST_RESOLVE, SETTINGS_GET_AGENT_DETAILS, SETTINGS_GET_MCP_SERVERS,
    SETTINGS_GET_PREFERENCES, SETTINGS_GET_RUNTIME, SETTINGS_GET_SKILLS,
    SETTINGS_GET_SKILL_DETAILS, SETTINGS_RESET_TASK_HISTORY, SETTINGS_UPDATE_PREFERENCES,
    ...
    TASK_ADOPT_NATIVE_SESSION, TASK_ARCHIVE, TASK_CANCEL, TASK_CHAT_PAGE, TASK_COMPOSER_HISTORY,
