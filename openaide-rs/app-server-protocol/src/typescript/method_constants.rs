use crate::methods::{
    ...
    ATTACHMENT_REVEAL, CLIENT_CAPABILITIES_CHANGED, CLIENT_HEARTBEAT, CLIENT_INITIALIZE,
    CLIENT_PROBE, DIAGNOSTICS_GET_RUNTIME, SETTINGS_GET_AGENT_DETAILS, SETTINGS_GET_MCP_SERVERS,
...
pub(super) fn push_method_constants(output: &mut String) {
    ...
    output.push_str(&format!(
        "export const TASK_RETRY_HISTORY_SYNC = {:?} as const;\n",
