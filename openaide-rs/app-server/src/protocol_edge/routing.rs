use openaide_app_server_protocol::methods::{
    AGENT_AUTHENTICATE, AGENT_CONFIG_OPTIONS, AGENT_CREATE_CUSTOM, AGENT_DELETE_CUSTOM,
    AGENT_LIST_SESSIONS, AGENT_PROBE, AGENT_REPLACE_CUSTOM, AGENT_SET_CONFIG_OPTION,
    AGENT_SET_ENABLED, AGENT_UPDATE_CUSTOM_METADATA, ATTACHMENT_CONFIRM_EMBEDDED,
    ...
    CLIENT_INITIALIZE, CLIENT_PROBE, DIAGNOSTICS_GET_RUNTIME, SETTINGS_GET_AGENT_DETAILS,
    ...
    TASK_CANCEL, TASK_CHAT_PAGE, TASK_CREATE, TASK_DISCARD, TASK_LIST, TASK_OPEN, TASK_SEND,
    TASK_SET_ARCHIVED, TASK_SET_CONFIG_OPTION, TASK_TOOL_DETAIL, WORKSPACE_LIST_DIRECTORY,
    ...
    pub fn handle_inbound(
        ...
        match method.as_str() {
            ...
            AGENT_CONFIG_OPTIONS => {
                self.handle_agent_config_options(connection_id, id, params, meta)
            }
            AGENT_SET_CONFIG_OPTION => {
                self.handle_agent_set_config_option(connection_id, id, params, meta)
            }
            AGENT_CREATE_CUSTOM => {
