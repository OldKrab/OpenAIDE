...
export const FILE_VIEWER_LIST_DIRECTORY = "fileViewer/listDirectory" as const;
export const FILE_VIEWER_SEARCH = "fileViewer/search" as const;
export const FILE_VIEWER_CHANGES = "fileViewer/changes" as const;
export const FILE_VIEWER_DIFF = "fileViewer/diff" as const;
...
export const SETTINGS_UPDATE_NEW_TASK_DEFAULTS = "settings/updateNewTaskDefaults" as const;
...
export const PROJECT_RENAME = "project/rename" as const;
export const PROJECT_REMOVE = "project/remove" as const;

export const PROJECT_REFRESH = "project/refresh" as const;

export const WORKTREE_REFRESH = "worktree/refresh" as const;
export const WORKTREE_CREATE = "worktree/create" as const;
export const WORKTREE_RECREATE = "worktree/recreate" as const;
export const WORKTREE_REMOVAL_PREFLIGHT = "worktree/removalPreflight" as const;
export const WORKTREE_REMOVE = "worktree/remove" as const;
export const WORKTREE_RENAME = "worktree/rename" as const;
export const WORKTREE_RESOLVE_FOLDER = "worktree/resolveFolder" as const;
export const WORKTREE_LINKED_TASKS = "worktree/linkedTasks" as const;

export const TASK_ACQUIRE = "task/acquire" as const;
export const TASK_ACQUIRE_IN_WORKTREE = "task/acquireInWorktree" as const;
...
export const TASK_CLOSE_PLAN = "task/closePlan" as const;
export const TASK_TOOL_IMAGE_PREVIEW = "task/toolImagePreview" as const;
export const FILE_VIEWER_OPEN = "fileViewer/open" as const;
export const FILE_VIEWER_OPEN_FROM_HANDLE = "fileViewer/openFromHandle" as const;
...
export const NATIVE_SESSION_DELETE = "nativeSession/delete" as const;
...
export type FileViewerHandleId = string & { readonly __openaideBrand: "FileViewerHandleId" };
...
export type WorktreeId = string & { readonly __openaideBrand: "WorktreeId" };

export type WorktreeOperationId = string & { readonly __openaideBrand: "WorktreeOperationId" };

export type WorktreeRepositoryId = string & { readonly __openaideBrand: "WorktreeRepositoryId" };
...
export type ProjectAddParams = { workspaceRoot: string, };

export type ProjectAddResult = { project: ProjectSummary, };

export type ProjectRenameParams = { projectId: ProjectId, label: string, };

export type ProjectRenameResult = { project: ProjectSummary, };

export type ProjectRemoveParams = { projectId: ProjectId, };

export type ProjectRemoveResult = { removedTaskCount: number, };

export type ProjectRefreshParams = { projectId: ProjectId, };

export type ProjectRefreshResult = { project: ProjectSummary, };
...
export type WorktreeRepositorySnapshot = { repositoryId: WorktreeRepositoryId, revision: number, worktrees: Array<WorktreeSummary>, bases?: Array<WorktreeBaseSnapshot>, operations?: Array<WorktreeOperationSnapshot>, };

export type WorktreeSummary = { worktreeId: WorktreeId, name: string, path: string,
/**
 * Historical metadata retained for linked Task history after the worktree is removed.
 */
forgotten: boolean, ownership: WorktreeOwnership, isMain: boolean, head: WorktreeHead, availability: WorktreeAvailability, availabilityReason?: string | null, lockedReason?: string | null, prunableReason?: string | null, projectIds?: Array<ProjectId>, linkedTaskCount: number, runningTaskCount: number, lastUsedAt?: string | null, };

export type WorktreeOwnership = "managed" | "external";

export type WorktreeAvailability = "available" | "unavailable";

export type WorktreeHead = { "kind": "branch", name: string, commit: string, } | { "kind": "detached", commit: string, };

export type WorktreeBaseSnapshot = { "kind": "head", commit: string, label: string, } | { "kind": "localBranch", name: string, commit: string, };

export type WorktreeBaseSelection = { "kind": "currentHead" } | { "kind": "localBranch", name: string, };

export type WorktreeOperationKind = "create" | "recreate" | "remove" | "refresh";

export type WorktreeOperationState = "queued" | "running" | "succeeded" | "failed";

export type WorktreeOperationSnapshot = { operationId: WorktreeOperationId, kind: WorktreeOperationKind, state: WorktreeOperationState, worktreeId?: WorktreeId | null, stage?: string | null, completedFiles?: number | null, totalFiles?: number | null, completedBytes?: number | null, totalBytes?: number | null, error?: string | null, };

export type WorktreeRefreshParams = { projectId: ProjectId, repositoryId: WorktreeRepositoryId, };

export type WorktreeRefreshResult = { repository: WorktreeRepositorySnapshot, };

export type WorktreeCreateParams = { projectId: ProjectId, repositoryId: WorktreeRepositoryId, name: string, base: WorktreeBaseSelection, branch?: string | null, };

export type WorktreeCreateResult = { operationId: WorktreeOperationId, repository: WorktreeRepositorySnapshot, };

export type WorktreeRecreateParams = { projectId: ProjectId, repositoryId: WorktreeRepositoryId, worktreeId: WorktreeId, base: WorktreeBaseSelection, branch?: string | null, };

export type WorktreeRecreateResult = { operationId: WorktreeOperationId, repository: WorktreeRepositorySnapshot, };

export type WorktreeRemovalPreflightParams = { repositoryId: WorktreeRepositoryId, worktreeId: WorktreeId, };

export type WorktreeRemovalPreflightResult = { preflight: WorktreeRemovalPreflight, };

export type WorktreeRemovalPreflight = { status: WorktreeRemovalStatus, blockers: Array<WorktreeRemovalBlocker>, ownership: WorktreeOwnership, path: string, ignoredFilesWillBeRemoved: boolean, };

export type WorktreeRemovalStatus = "safe" | "blocked";

export type WorktreeRemovalBlocker = "primaryWorktree" | "runningTasks" | "locked" | "unavailable" | "workingTreeChanges" | "detachedCommits" | "initializedSubmodules";

export type WorktreeRemoveParams = { repositoryId: WorktreeRepositoryId, worktreeId: WorktreeId, };

export type WorktreeRemoveResult = { operationId: WorktreeOperationId, repository: WorktreeRepositorySnapshot, };

export type WorktreeRenameParams = { repositoryId: WorktreeRepositoryId, worktreeId: WorktreeId, name: string, };

export type WorktreeRenameResult = { repository: WorktreeRepositorySnapshot, };

export type WorktreeResolveFolderParams = { repositoryId: WorktreeRepositoryId, worktreeId: WorktreeId, };

export type WorktreeResolveFolderResult = { path: string, };

export type WorktreeLinkedTasksParams = { repositoryId: WorktreeRepositoryId, worktreeId: WorktreeId, };

export type WorktreeLinkedTasksResult = { taskIds: Array<TaskId>, };
...
export type TaskAcquireParams = { projectId: ProjectId, agentId: AgentId,
/**
...
export type TaskAdoptNativeSessionParams = { agentId: AgentId, nativeSessionId: string, };
...
export type TaskSetPermissionPolicyParams = { taskId: TaskId, policy: TaskPermissionPolicy, };

export type TaskSetPermissionPolicyResult = {
/**
...
export type TaskTitleSelection = { "kind": "user", value: string, } | { "kind": "automatic" };
...
export type TaskClosePlanParams = { taskId: TaskId, };

export type TaskClosePlanResult = { task: TaskSnapshot, };
...
export type ProjectFilesParams = { taskId: TaskId, path: string, query: string, content: boolean, caseSensitive: boolean,
/**
 * Search respects ignore files unless explicitly requested. Tree browsing includes ignored files.
 */
includeIgnored: boolean, cursor: number, };

export type ProjectFilesResult = { entries: Array<ProjectFileEntry>, nextCursor: number | null,
/**
 ...
 */
error: string | null, branch: string | null, base: string | null, diff: ProjectFileDiff | null, };

export type ProjectFileEntry = { path: string, name: string, directory: boolean, status: string | null, oldPath: string | null, line: number | null, text: string | null, };

export type ProjectFileDiff = { path: string, oldPath: string | null, binary: boolean, conflicted: boolean, hunks: Array<ProjectDiffHunk>, };

export type ProjectDiffHunk = { heading: string, lines: Array<ProjectDiffLine>, };

export type ProjectDiffLine = { kind: string, text: string, oldLine: number | null, newLine: number | null, };

export type FileViewerOpenParams = { taskId: TaskId, path: string, line?: number | null, };

export type FileViewerOpenFromHandleParams = { handle: FileViewerHandleId, href: string, };

export type FileViewerRefreshParams = { handle: FileViewerHandleId, line?: number | null, };

export type FileViewerReleaseParams = { handle: FileViewerHandleId, };
...
export type TaskReloadNativeSessionParams = { taskId: TaskId, clientMutationId: ClientMutationId, };

export type TaskReloadNativeSessionResult = { task: TaskSnapshot, };
...
export type TaskNavigationLoadMoreParams = { projectId: ProjectId, targetRowCount: number, };

export type TaskNavigationLoadMoreResult = { accepted: boolean, };

export type NativeSessionArchiveParams = { agentId: AgentId, nativeSessionId: string, };
...
export type NativeSessionDeleteTarget = { "kind": "task", taskId: TaskId, } | { "kind": "nativeSession", agentId: AgentId, nativeSessionId: string, };

export type NativeSessionDeleteConfirmation = { active: boolean, queuedMessageCount: number, };

export type NativeSessionDeleteParams = { target: NativeSessionDeleteTarget,
/**
 * Omit to obtain the authoritative confirmation details without deleting anything.
 */
confirmation?: NativeSessionDeleteConfirmation | null, };

export type NativeSessionDeleteResult = { "kind": "confirmationRequired", title: string, active: boolean, queuedMessageCount: number, } | { "kind": "deleted", reference: NativeSessionReference, projectId: ProjectId, taskId: TaskId | null, };

export type NativeSessionForkSource = { "kind": "task", taskId: TaskId, } | { "kind": "nativeSession", agentId: AgentId, nativeSessionId: string, };

export type NativeSessionForkParams = { source: NativeSessionForkSource, };

export type NativeSessionForkResult = { reference: NativeSessionReference, projectId: ProjectId, closeWarning: boolean, };

export type TaskReleaseParams = { taskId: TaskId, };
...
export type ProjectSummary = { projectId: ProjectId, label: string, workspaceRoot: string, available: boolean, worktreeRepositoryId?: WorktreeRepositoryId | null, projectWorktreeId?: WorktreeId | null, worktreeError?: string | null, };
...
export type TaskHistorySyncSnapshot = { "state": "idle", generation: number, } | { "state": "reloadAvailable", generation: number, } | { "state": "syncing", generation: number, } | { "state": "updated", generation: number, };
...
export type RequestParamsByMethod = {
  ...
  [FILE_VIEWER_CHANGES]: ProjectFilesParams;
  [FILE_VIEWER_DIFF]: ProjectFilesParams;
  ...
  [SETTINGS_UPDATE_NEW_TASK_DEFAULTS]: NewTaskDefaultsUpdateParams;
  ...
  [PROJECT_ADD]: ProjectAddParams;
  [PROJECT_RENAME]: ProjectRenameParams;
  [PROJECT_REMOVE]: ProjectRemoveParams;
  [PROJECT_REFRESH]: ProjectRefreshParams;
  [WORKTREE_REFRESH]: WorktreeRefreshParams;
  [WORKTREE_CREATE]: WorktreeCreateParams;
  [WORKTREE_RECREATE]: WorktreeRecreateParams;
  [WORKTREE_REMOVAL_PREFLIGHT]: WorktreeRemovalPreflightParams;
  [WORKTREE_REMOVE]: WorktreeRemoveParams;
  [WORKTREE_RENAME]: WorktreeRenameParams;
  [WORKTREE_RESOLVE_FOLDER]: WorktreeResolveFolderParams;
  [WORKTREE_LINKED_TASKS]: WorktreeLinkedTasksParams;
  [TASK_ACQUIRE]: TaskAcquireParams;
  [TASK_ACQUIRE_IN_WORKTREE]: TaskAcquireInWorktreeParams;
  ...
  [TASK_CLOSE_PLAN]: TaskClosePlanParams;
  [TASK_TOOL_IMAGE_PREVIEW]: TaskToolImagePreviewParams;
  [FILE_VIEWER_OPEN]: FileViewerOpenParams;
  [FILE_VIEWER_OPEN_FROM_HANDLE]: FileViewerOpenFromHandleParams;
  ...
  [NATIVE_SESSION_DELETE]: NativeSessionDeleteParams;
...
export type ResponseResultByMethod = {
  [FILE_VIEWER_LIST_DIRECTORY]: ProjectFilesResult;
  [FILE_VIEWER_SEARCH]: ProjectFilesResult;
  [FILE_VIEWER_CHANGES]: ProjectFilesResult;
  [FILE_VIEWER_DIFF]: ProjectFilesResult;
  ...
  [SETTINGS_UPDATE_NEW_TASK_DEFAULTS]: NewTaskDefaultsSnapshot;
  ...
  [PROJECT_ADD]: ProjectAddResult;
  [PROJECT_RENAME]: ProjectRenameResult;
  [PROJECT_REMOVE]: ProjectRemoveResult;
  [PROJECT_REFRESH]: ProjectRefreshResult;
  [WORKTREE_REFRESH]: WorktreeRefreshResult;
  [WORKTREE_CREATE]: WorktreeCreateResult;
  [WORKTREE_RECREATE]: WorktreeRecreateResult;
  [WORKTREE_REMOVAL_PREFLIGHT]: WorktreeRemovalPreflightResult;
  [WORKTREE_REMOVE]: WorktreeRemoveResult;
  [WORKTREE_RENAME]: WorktreeRenameResult;
  [WORKTREE_RESOLVE_FOLDER]: WorktreeResolveFolderResult;
  [WORKTREE_LINKED_TASKS]: WorktreeLinkedTasksResult;
  [TASK_ACQUIRE]: TaskAcquireResult;
  [TASK_ACQUIRE_IN_WORKTREE]: TaskAcquireInWorktreeResult;
  ...
  [TASK_CLOSE_PLAN]: TaskClosePlanResult;
  [TASK_TOOL_IMAGE_PREVIEW]: TaskToolImagePreviewResult;
  [FILE_VIEWER_OPEN]: FileViewerSnapshot;
  [FILE_VIEWER_OPEN_FROM_HANDLE]: FileViewerSnapshot;
  ...
  [NATIVE_SESSION_DELETE]: NativeSessionDeleteResult;
...
export type ProjectAddRequest = TypedClientRequest<typeof PROJECT_ADD>;
export type ProjectAddResponse = ResponseEnvelope<ProjectAddResult>;
export type ProjectRenameRequest = TypedClientRequest<typeof PROJECT_RENAME>;
export type ProjectRenameResponse = ResponseEnvelope<ProjectRenameResult>;
export type ProjectRemoveRequest = TypedClientRequest<typeof PROJECT_REMOVE>;
export type ProjectRemoveResponse = ResponseEnvelope<ProjectRemoveResult>;
export type ProjectRefreshRequest = TypedClientRequest<typeof PROJECT_REFRESH>;
export type ProjectRefreshResponse = ResponseEnvelope<ProjectRefreshResult>;
