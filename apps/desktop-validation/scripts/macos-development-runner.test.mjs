...
test("the macOS runner launches the executable inside the development app bundle", () => {
  assert.equal(
    developmentBundleExecutable("/work/OpenAIDE/apps/desktop-validation/src-tauri", {}),
    path.join(
      "/work/OpenAIDE/apps/desktop-validation/src-tauri",
      "target/debug/bundle/macos/OpenAIDE Development.app/Contents/MacOS/openaide-desktop-validation",
    ),
  );
});
